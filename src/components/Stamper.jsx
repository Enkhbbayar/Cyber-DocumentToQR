...
const Stamper = () => {
  ...
  return (
    <main
      id="main"
      className="flex flex-col flex-wrap justify-center md:items-center md:flex-row "
    >
      <div className="flex flex-col justify-center items-center text-center gap-5 flex-1 ">
        ...
        <h2>QR кодонд оруулах мэдээллийг бөглөнө үү</h2>
        ...
        />
        <label htmlFor="content">Нэмэлт</label>
        <input
          className="p-[1rem] w-3/4 md:w-1/2"
          id="content"
          type="text"
        ...
        />
        <label htmlFor="upload">Файл оруулна уу?</label>
        <input
          id="upload"
          type="file"
          accept=".pdf"
        ...
        />
        <p className="w-3/4 md:w-1/2 text-purple-500">
          Таны оруулсан файл нь бидэнд хадгалан үлдэгдэхгүй.
        </p>
            ...
            <div className="flex relative w-full px-10">
              ...
              <div className="w-full h-screen mt-16">
                ...
                <h2 className="text-center pb-5">
                  QR кодын байрлалыг тохируулахын тулд гулсагчийг хөдөлгөнө үү
                </h2>
                <object
